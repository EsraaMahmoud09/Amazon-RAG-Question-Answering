...
# ==========================================
# 5. Header & Banner (Fix: added unsafe_allow_html=True)
# ==========================================
st.markdown("""
...
<div class="welcome-card">
    ...
    <div style="color: #e0e7ff; font-size: 15px; margin-top: 6px;">Discover products and ask our AI assistant questions about customer reviews.</div>
</div>
""", unsafe_allow_html=True)
...
# ==========================================
# 6. Featured Products (Fix: added unsafe_allow_html=True)
# ==========================================
